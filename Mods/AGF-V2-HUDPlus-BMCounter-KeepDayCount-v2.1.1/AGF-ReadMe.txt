HUDPlus - BMCounter-KeepDayCount
7d2d V2 - v2.1.1
...
3.  INSTALLATION and REMOVAL NOTES
	...
	***Requires the Main HUDPlus mod, as this is an optional addon to it.***
	...
	-HUDPlus - BMCounter-KeepDayCount is SAFE to install on new or existing games.
	-HUDPLus - BMCounter-KeepDayCount is SAFE to remove from an existing game.
